...
| `Alt + Shift + f` | Launch File Manager (index) |
| `Alt + Shift + g` | Launch File Manager (pcmanfm-qt) |
| `Alt + Shift + e` | Launch Text Editor (nota) |
| `Alt + Shift + b` | Launch Web Browser (firefox) |
| `Alt + Shift + s` | Launch System Setting (systemsettings) |
| `Alt + Enter` | Launch Terminal (station) |
| `Alt + Shift + a` | Launch Terminal (station) |
| `Alt + Ctrl + a` | Launch Terminal (sakura) |
| `Alt + Shift + t` | Launch Terminal (station) |
